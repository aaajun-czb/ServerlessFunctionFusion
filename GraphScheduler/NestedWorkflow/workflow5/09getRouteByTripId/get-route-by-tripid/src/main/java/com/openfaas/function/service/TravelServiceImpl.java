...
public class TravelServiceImpl implements TravelService {
    ...
    public static String function03_URI = "gateway.openfaas:8080/function/get-route-by-routeid.openfaas-fn";
    String success = "Success";
    String noContent = "No Content";

    public static void updateFunctionURI(String _function03_URI){
