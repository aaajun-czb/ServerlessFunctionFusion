...
public class TravelServiceImpl implements TravelService {
    ...
    public static String function03_URI = "localhost:8086";
    ...
    public static String function07_URI = "localhost:8088";
    public static String function08_URI = "localhost:8081";
    
    public static void updateFunctionURI(String _function03_URI, String _function07_URI, String _function08_URI){
        function03_URI = _function03_URI;
        function07_URI = _function07_URI;
        function08_URI = _function08_URI;
    }
