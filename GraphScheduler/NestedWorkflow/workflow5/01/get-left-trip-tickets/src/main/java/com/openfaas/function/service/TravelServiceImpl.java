...
public class TravelServiceImpl implements TravelService {
    ...
    private String queryForStationIdViaHttp(String stationName) {
        ...
        try {
            ...
            String container_name = System.getenv("07");
            String requestBody = "{\"container_name\": \"" + container_name + "\", \"jar_name\": \"query-for-station-id-by-station-name.jar\", \"calling_container\": \"" + callingContainer + "\" , \"data\": " + json + "}";
    ...
    private int getRestTicketNumberViaHttp(Seat seatRequest) {
        ...
        try {
            ...
            // 读取环境变量 CALLING_CONTAINER
            String callingContainer = System.getenv("CALLING_CONTAINER");
            String container_name = System.getenv("08");
            String requestBody = "{\"container_name\": \"" + container_name + "\", \"jar_name\": \"get-left-ticket-of-interval.jar\", \"calling_container\": \"" + callingContainer + "\" , \"data\": " + json + "}";
            RequestBody body = RequestBody.create(
                    MediaType.parse("application/json"), requestBody);
            Request request = new Request.Builder()
                    .url("http://127.0.0.1:5000/invoke")
