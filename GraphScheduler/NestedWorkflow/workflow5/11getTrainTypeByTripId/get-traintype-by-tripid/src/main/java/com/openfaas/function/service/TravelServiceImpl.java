...
public class TravelServiceImpl implements TravelService {
    ...
    public static String function04_URI = "gateway.openfaas:8080/function/get-traintype-by-traintypeid.openfaas-fn";

    String success = "Success";
    String noContent = "No Content";

    public static void updateFunctionURI(String _function04_URI){
		function04_URI = _function04_URI;
	}
