...
public class TravelServiceImpl implements TravelService {
    ...
    private TrainType getTrainTypeViaHttp(String trainTypeId) {
        ...
        try {
            ...
            String container_name = System.getenv("04");
            String requestBody = "{\"container_name\": \"" + container_name + "\", \"jar_name\": \"get-traintype-by-traintypeid.jar\", \"calling_container\": \"" + callingContainer + "\" , \"data\": " + json + "}";
